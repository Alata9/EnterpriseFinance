    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expense_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='payments.expensegroup')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='payments.expensesitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, max_digits=15)),
                ('comments', models.CharField(blank=True, max_length=255)),
                ('account', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='directory.paymentaccount')),
                ('counterparty', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='directory.counterparties')),
                ('item', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='payments.expensesitem')),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='directory.organization')),
